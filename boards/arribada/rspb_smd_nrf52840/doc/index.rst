...
The Arribada RSPB board is based on nRF52840 ARM Cortex-M4F CPU and SMD Argos module
...
.. figure:: img/RSPB_MD_NRF52840_TOP.jpg
     :align: center
     :alt: RSPB SMD nRF52840
.. figure:: img/RSPB_MD_NRF52840_BOTTOM.jpg
     :align: center
     :alt: RSPB SMD nRF52840
...
- Reed switch
- SWD connector
- GNSS with uBlox M10Q chipset
- Argos communication with Argos SMD module
- Accelerometer
...
Applications for the ``rspb_smd_nrf52840`` board configuration
...
Flashing Zephyr onto the ``rspb_smd_nrf52840`` board requires
